...
变量
export jkdhd='{"openid": "替换的","channel": "iOS","os": "iOS","appversioncode": "565","time": "1630328609","psign": "替换的","apptoken": "替换的","appid": "xzwl","appversion": "5.6.5"}'
...
qlhd = decodeURIComponent  (jkdhd)
qlhd = qlhd.match(/jsondata=(.+)"/)[1]
//$.log(qlhd)
    let nm = {
...
qlhd = JSON.parse(jkdhd)
    ...
    let nm = {
     ...
     body: `jsondata={  "openid" : "${qlhd.openid}",  "channel" : "iOS",  "os" : "iOS",  "appversioncode" : "565",  "time" : "1630331719",  "psign" : "${qlhd.psign}",  "position" : ${position},  "apptoken" : "${qlhd.apptoken}",  "appid" : "xzwl",  "appversion" : "5.6.5"}`,
     //14 17
     headers:JSON.parse(jkdck)
 ...
 return new Promise((resolve) => {
qxhd = decodeURIComponent  (jkdhd)
qxhd = qxhd.match(/jsondata=(.+)"/)[1]
...
qlhd = JSON.parse(jkdhd)
    let nm = {
     url: `https://www.xiaodouzhuan.cn/jkd/account/readAccount.action`,
     body: `jsondata={  "appid" : "xzwl",  "read_weal" : 0,  "paytype" : 1,  "securitykey" : "",  "channel" : "iOS",  "psign" : "${qlhd.psign}",  "appversioncode" : "565",  "time" : "1630332532",  "apptoken" : "${qlhd.apptoken}",  "appversion" : "5.6.5",  "openid" : "${qlhd.openid}",  "os" : "iOS",  "artid" : 812907${Math.round(Math.random()*9)}${s},  "accountType" : "0",  "readmodel" : "1"}`,
...
qlhd = JSON.parse(jkdhd)
    let nm = {
     url: `https://www.xiaodouzhuan.cn/jkd/account/readAccount.action`,
     body: `jsondata={  "appid" : "xzwl",  "read_weal" : 0,  "paytype" : 2,  "securitykey" : "",  "channel" : "iOS",  "psign" : "${qlhd.psign}",  "appversioncode" : "565",  "time" : "1630332532",  "apptoken" : "${qlhd.apptoken}",  "appversion" : "5.6.5",  "openid" : "${qlhd.openid}",  "os" : "iOS",  "artid" : ${artid},  "accountType" : "0",  "readmodel" : "1"}`,
...
qlhd = JSON.parse(jkdhd)
    let nm = {
     ...
     body: `jsondata={  "appid" : "xzwl",  "connectionType" : 100,  "optaction" : "up",  "pagesize" : 12,  "channel" : "iOS",  "psign" : "${qlhd.psign}",  "appversioncode" : "565",  "time" : "1630337840",  "apptoken" : "${qlhd.apptoken}",  "cateid" : 53,  "openid" : "${qlhd.openid}",  "os" : "iOS",  "appversion" : "5.6.5",  "idfa" : "1E83F5F8-7908-45CD-907A-DE1E93F505D6",  "operatorType" : 3,  "page" : 3}`,
...
qlhd = JSON.parse(jkdhd)
    let nm = {
     ...
     //body: `jsondata={  "appid" : "xzwl",  "connectionType" : 100,  "optaction" : "up",  "pagesize" : 12,  "channel" : "iOS",  "psign" : "${qlhd.psign}",  "appversioncode" : "565",  "time" : "1630337840",  "apptoken" : "${qlhd.apptoken}",  "cateid" : 53,  "openid" : "${qlhd.openid}",  "os" : "iOS",  "appversion" : "5.6.5",  "idfa" : "1E83F5F8-7908-45CD-907A-DE1E93F505D6",  "operatorType" : 3,  "page" : 3}`,
body: `jsondata={  "appid" : "xzwl",  "channel" : "iOS",  "psign" : "${qlhd.psign}",  "appversioncode" : "565",  "time" : "1630337593",  "apptoken" : "${qlhd.apptoken}",  "requestid" : "1630337520179543",  "openid" : "${qlhd.openid}",  "os" : "iOS",  "artid" : ${artid},  "appversion" : "5.6.5",  "relate" : "1",  "scenetype" : ""}`,
     headers:JSON.parse(jkdck)
...
qxhd = JSON.parse(qxhd)
    let nm = {
     url: `https://www.xiaodouzhuan.cn/jkd/newmobile/artlist.action`,
     body: `jsondata={  "appid" : "xzwl",  "connectionType" : 100,  "optaction" : "up",  "pagesize" : 12,  "channel" : "iOS",  "psign" : "${qxhd.psign}",  "appversioncode" : "565",  "time" : "1630337840",  "apptoken" : "${qxhd.apptoken}",  "cateid" : 53,  "openid" : "${qxhd.openid}",  "os" : "iOS",  "appversion" : "5.6.5",  "idfa" : "1E83F5F8-7908-45CD-907A-DE1E93F505D6",  "operatorType" : 3,  "page" : 3}`,
...
//$.log(data)
    ...
    if(result.ret=="ok"){
       qxlist = result.artlist

        qxid = qxlist[0]['art_id']
        $.log(qxid)
        await qxartDetail(qxid)
        await $.wait(5000)
        await qxvideo(qxid)
...
qxhd = JSON.parse(qxhd)
    let nm = {
     url: `https://www.xiaodouzhuan.cn/jkd/newmobile/artDetail.action`,
     //body: `jsondata={  "appid" : "xzwl",  "connectionType" : 100,  "optaction" : "up",  "pagesize" : 12,  "channel" : "iOS",  "psign" : "${qlhd.psign}",  "appversioncode" : "565",  "time" : "1630337840",  "apptoken" : "${qlhd.apptoken}",  "cateid" : 53,  "openid" : "${qlhd.openid}",  "os" : "iOS",  "appversion" : "5.6.5",  "idfa" : "1E83F5F8-7908-45CD-907A-DE1E93F505D6",  "operatorType" : 3,  "page" : 3}`,
body: `jsondata={  "appid" : "xzwl",  "channel" : "iOS",  "psign" : "${qxhd.psign}",  "appversioncode" : "565",  "time" : "1630337593",  "apptoken" : "${qxhd.apptoken}",  "requestid" : "1630337520179543",  "openid" : "${qxhd.openid}",  "os" : "iOS",  "artid" : ${artid},  "appversion" : "5.6.5",  "relate" : "1",  "scenetype" : ""}`,
     headers:JSON.parse(jkdck)
